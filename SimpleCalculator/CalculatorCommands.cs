    ...
    public class CalculatorCommands
    {
        ...
        public string OutputControl(string input, Stack current_stack, Variables current_variables)
        {
            ...
            switch (input)
            {
                ...
                case "lastq": return (current_stack.LastCommand != null) ? current_stack.LastCommand : "You've got no last command, dummy!";
                case "last": return (current_stack.LastAnswer != null) ? current_stack.LastAnswer : "You've got not last answer, dummy!";
